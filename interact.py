...
def load_model_from_experiment(experiment_folder: str):
    ...
    model = GPT2LanguageModel.load_from_metrics(
...
if __name__ == "__main__":
    parser = HyperOptArgumentParser(
        description="Minimalist GPT2 Generator", add_help=True
    )
    parser.add_argument(
    ...
    while 1:
        print("Please write some text or quit to exit the interactive shell ('quit' or 'q'):")
        # Get input sentence
